#!/home/takhsm/app/anaconda2/bin/python
...
print par
if len(par)<3:
    print "pPlotAllSky.py [suffix] [NSIDE] [list of tree file]"
    sys.exit(0)
suffix = par[1]
...
TPL_DIR_DEDICATED = ('fits', 'png', 'numpy', 'MonitorSmearing')
...
#["/disk/gamma/cta/store/takhsm/FermiMVA/MVA/S18/S18V200909_020RAWE20ZDIR020ZCS000wwoTRKwoMCZDIR00woRWcatTwo_15/S18ZDIR020catTwoZDIR060_E28binx_Cth40bins_CalOnly_R100_perf.root", 
#"/disk/gamma/cta/store/takhsm/FermiMVA/MVA/S18/S18V200909_020RAWE20ZDIR020ZCS000wwoTRKwoMCZDIR00woRWcatTwo_15/S18ZDIR020catTwoZDIR060_E28binx_Cth40bins_CalOnly_R030_perf.root", 
# "/disk/gamma/cta/store/takhsm/FermiMVA/MVA/S18/S18V200909_020RAWE20ZDIR020ZCS000wwoTRKwoMCZDIR00woRWcatTwo_15/S18ZDIR020catTwoZDIR060_E28binx_Cth40bins_CalOnly_R010_perf.root"]]
# "/disk/gamma/cta/store/takhsm/FermiMVA/MVA/S18/S18V200909_020RAWE20ZDIR020ZCS000wwoTRKwoMCZDIR00woRWcatTwo_15/S18ZDIR020catTwoZDIR060_E28binx_Cth40bins_CalOnly_R003_perf.root"]]
...
for obj in pTransientCatalogue.aObjectDict:
    aTrs.append(PointSource(obj["Name"], obj["RA"], obj["DEC"], obj["L"], obj["B"], obj["Z"], rAppa, rOffMax, rOffMin, rOnMax, cfg, er, erplot, htgPerf, nhpside=NHPSIDE, tStart=obj["Start"], tEnd=obj["End"]))
...
#            lstt_hp_htg[ch.c-1][clsPlus].Fill(ch.e, ch.cth, hppf.ang2pix(NHPSIDE, math.pi/2.-math.radians(ch.dec), math.radians(ch.ra))+0.5)
    ...
    for ingal in aInnerGal:
        ingal.fill(ch.ra, ch.dec, ch.l, ch.b, ch.e, ch.c, cls, ch.z, ch.t, ch.cth)
    for tgt in aTgt:
...
print 'Intermediate Healpix cube:', lstt_healcube
fileOut.cd(ridge.name)
...
for tgt in aTgt:
    ...
    tgt.setHealCube(copy.deepcopy(ridge.lstt_narr_hp))
    tgt.drawHealPlot()
    tgt.smear()
    fileOut.cd(tgt.name)
    tgt.draw()
...
#     fileOut.cd(trs.name)
#     trs.calc()
#     trs.setPixelDistanceTable(10)
#     trs.setHealCube(copy.deepcopy(ridge.lstt_narr_hp))
#     trs.drawHealPlot()
#     trs.smear()
#     fileOut.cd(trs.name)
#     trs.draw()
