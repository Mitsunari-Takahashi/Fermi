...
#chDat = ROOT.TChain('MeritTuple')
    ...
    for iEvent in range(nEvent):
        ...
        dictDistCut = { 'PSF95': (htgPerf.getPSF95_cth(chIn.c-1, 0*(chIn.s==4 or chIn.s==4096)+1*(chIn.s==128 or chIn.s==8192)+2*(chIn.s==16384), chIn.e, chIn.cth) + err_rad), 'PSF68': (htgPerf.getPSF68_cth(chIn.c-1, 0*(chIn.s==4 or chIn.s==4096)+1*(chIn.s==128 or chIn.s==8192)+2*(chIn.s==16384), chIn.e, chIn.cth) + err_rad) }
